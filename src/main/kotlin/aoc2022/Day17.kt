...
object Day17 {
    ...
    fun part1(input: List<Vector2>): Long {
        return simulateRocks(input, 2022).fillHeight
    }

    fun part2(input: List<Vector2>): Long {
        return simulateRocks(input, 1_000_000_000_000).fillHeight
    }
}
