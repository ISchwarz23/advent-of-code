...
internal class Day04Test {
    ...
    private val input = readInput("aoc2020/day04.txt")
    private val inputExample = readInput("aoc2020/day04_example.txt")
    ...
    internal fun testPart1() {
        ...
        val submissionResult = aocClient.submit(2020, 4, 1, answer)
    ...
    internal fun testPart2() {
        ...
        val submissionResult = aocClient.submit(2020, 4, 2, answer)
