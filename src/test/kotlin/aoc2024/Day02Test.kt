...
internal class Day02Test {
    ...
    private val input = readInput("aoc2024/day02.txt")
    private val inputExample = readInput("aoc2024/day02_example.txt")
    ...
    internal fun testPart1() {
        ...
        val submissionResult = aocClient.submit(2024, 2, 1, answer)
    ...
    internal fun testPart2() {
        ...
        val submissionResult = aocClient.submit(2024, 2, 2, answer)
